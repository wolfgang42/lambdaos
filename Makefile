...
OBJECTS=boot.s.o kernel.o gdt.o gdt.s.o idt.o idt.s.o isr.o isr.s.o irq.o irq.s.o driver/vga.o driver/timer.o driver/kbd_ps2.o lib/str.o lib/mem.o lib/printf.o
...
driver/kbd_ps2.o: driver/kbd_ps2.c irq.h kernel.h
	$(GCC) -c driver/kbd_ps2.c -o driver/kbd_ps2.o -std=gnu99 -ffreestanding -O2 -Wall -Wextra
